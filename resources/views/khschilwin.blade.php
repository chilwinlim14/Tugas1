...
<div class="wrapper">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="nav nav-pills">
          ...
          <li class="nav-item">
            <a class="nav-link" style="color:white" href="/khs">Lihat KHS</a>
          </li>
        </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/MONTEA.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">CHILWIN</a>
        </div>
      </div>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <section style="padding: 20px; background-color: rgba(0,0,0,0.6);">
